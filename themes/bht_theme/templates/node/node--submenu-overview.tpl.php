...
$link_attributes_array['class'][] = 'submenu__item-link';
$link_attributes_array['class'][] = 'submenu__item-link--' . $css_modifier;

// Add the title classes to the title_attributes_array
$title_attributes_array = array();
$title_attributes_array['class'][] = 'item-title';
$title_attributes_array['class'][] = 'submenu__item-title';
$title_attributes_array['class'][] = 'submenu__item-title--' . $css_modifier;

// Add the wrapper classes to the attributes_array
$content_attributes_array = array();
$content_attributes_array['class'][] = 'submenu__item-content';
$content_attributes_array['class'][] = 'submenu__item-content--' . $css_modifier;
?>

<a href="<?php print url('node/' . $nid); ?>" <?php print drupal_attributes($link_attributes_array); ?>>
