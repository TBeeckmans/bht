...
<div>
  <div class="popup-content info">
    ...
    <div id="popup-buttons">
      <button type="button" class="btn btn--default agree-button"><?php print $agree_button; ?></button>
      <button type="button" class="btn btn--default find-more-button"><?php print $disagree_button; ?></button>
    </div>
  </div>
</div>
