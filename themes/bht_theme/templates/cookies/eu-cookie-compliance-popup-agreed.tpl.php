...
<div>
  <div class="popup-content agreed">
    ...
    <div id="popup-buttons">
      <button type="button" class="btn btn--default hide-popup-button"><?php print $hide_button; ?></button>
      <button type="button" class="btn btn--default find-more-button" ><?php print $find_more_button; ?></button>
    </div>
  </div>
</div>