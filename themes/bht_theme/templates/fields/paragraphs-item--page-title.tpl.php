...
$classes_array[] = $css_element . '--paragraph';
if (!empty($css_block)) {
  $classes_array[] = $css_block . '__' . $css_element;
  $classes_array[] = $css_block . '__' . $css_element . '--paragraph';
}

// Update the attributes array with the new classes array
$attributes_array['class'] = $classes_array;

// Add the itemprop to the h1
$attributes_array['itemprop'] = 'name';
?>


<h1 <?php print drupal_attributes($attributes_array); ?>>
