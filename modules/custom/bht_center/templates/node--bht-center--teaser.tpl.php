...
<div itemscope itemtype="http://schema.org/LocalBusiness"
     class="contact__item"<?php if (isset($lat[0]['value'])) {
  print " data-lat=\"{$lat[0]['value']}\"";
} ?> <?php if (isset($long[0]['value'])) {
  print " data-long=\"{$long[0]['value']}\"";
  ...
  <div class="layout__item">
    ...
    <?php if (isset($content['street']) || isset($content['postal_code']) || isset($content['city']) || isset($content['country'])) : ?>
      <div class="contact__address" itemprop="address" itemscope
        ...
        <?php if (isset($content['postal_code'])): ?>
          <span itemprop="postalCode"><?php print render(
              $content['postal_code']
            ); ?></span>
        <?php endif; ?>

        <?php if (isset($content['city'])): ?>
          <span itemprop="addressLocality"><?php print render(
              $content['city']
            ); ?></span><br>
        <?php endif; ?>

        <?php if (isset($content['country'])): ?>
          <span itemprop="addressCountry"><?php print render(
              $content['country']
            ); ?></span>
        <?php endif; ?>
    ...
    <?php if (isset($content['email'])): ?>
      <div class="contact__email"><?php print render(
          $content['email']
        ); ?></div>
    <?php endif; ?>
    <?php if (isset($content['phone'])): ?>
      <div class="contact__phone"><?php print render(
          $content['phone']
        ); ?></div>
    <?php endif; ?>
    <?php if (isset($content['mobile_phone'])): ?>
      <div class="contact__mobile-phone"><?php print render(
    ...
    <?php if (isset($content['render_map'])): ?>
      <div class="contact__map" itemprop="map"><?php print render(
          $content['render_map']
        ); ?></div>
    <?php endif; ?>
